...
const FeaturedProducts = ({ onNavigate }: FeaturedProductsProps = {}) => {
  ...
  // Buscar produtos reais do catálogo
  ...
  ].filter(Boolean).slice(0, 6); // Pegar apenas 6 produtos válidos
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-2xl p-8">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              {t('products.viewComplete.desc').replace('{count}', getAllProducts().length.toString())}
            </p>
            <button
